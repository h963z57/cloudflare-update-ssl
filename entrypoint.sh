...
echo "Connect to S3"
./mc alias set s3 $S3_ADDRESS $S3_LOGIN "'$3_PASSWORD'"

echo "Copy files to s3"
./mc cp /etc/letsencrypt/live/h963z57.com/fullchain.pem s3/$S3_PATH/fullchain.pem
./mc cp /etc/letsencrypt/live/h963z57.com/privkey.pem s3/$S3_PATH/privkey.pem
